...
const apiURL = "//api.openweathermap.org/data/2.5/weather?q=5604473&appid=78b78816d97bf3ea58188b7f4b8332fb&units=imperial"
...
fetch(apiURL)
  ...
  .then((weatherInfo) => {
    ...
    document.getElementById('ceu').innerHTML=weatherInfo.name;
