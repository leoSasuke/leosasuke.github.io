...
fetch(apiURLweather)
 ...
 fetch(api)
  ...
  .then((festa) => {
    ...
    document.getElementById('first').innerHTML = festa.towns[4].events[0];
    document.getElementById('second').innerHTML = festa.towns[4].events[1];
    document.getElementById('third').innerHTML = festa.towns[4].events[2];
  });
